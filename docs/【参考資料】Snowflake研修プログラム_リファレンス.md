...
3. [Git](#3-git)
4. [GitHub](#4-github)
5. [Git 運用ルール](#5-git-運用ルール)
6. [Terraform](#6-terraform)
7. [dbt](#7-dbt)
8. [CI/CD パイプライン](#8-cicd-パイプライン)
9. [AWS 環境構築](#9-aws-環境構築)
10. [Snowflake 環境構築](#10-snowflake-環境構築)
...
### 8.1 全体フロー（GitHub Actions → HCP Terraform → Snowflake）
...
### 8.2 GitHub Secrets / Environments の構成
...
### 9.3 Lambda 依存ライブラリのパッケージング（Lambda レイヤー方式）
