...
5. [GitHub環境構築（4h）](#chapter-5)

6. [TerraformによるSnowflakeオブジェクトの定義（10h）](#chapter-6)

7. [dbtによるデータ加工（8h）](#chapter-7)

8. [Streamlitアプリケーションの実装（8h）](#chapter-8)

9. [レポート作成（8h）](#chapter-9)
...
## 6. TerraformによるSnowflakeオブジェクトの定義（10h）
