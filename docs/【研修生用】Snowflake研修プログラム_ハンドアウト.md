...
不明な用語については[Snowflake研修リファレンス-AWS環境構築](【参考資料】Snowflake研修プログラム_リファレンス.md#8-aws-環境構築)を参照しつつ進めてください。
...
Parameters:
  TraineeUserName:
    Type: String
    Description: 'Enter your trainee username (e.g. trainee01)' #TODO: ユーザー名を正しく入力してください。
...
Resources:
  ...
  MailBucket:
    ...
    Properties:
      BucketName: !Sub '${TraineeUserName}-bucket' #TODO: バケット名を正しく指定してください。
      ...
      PolicyDocument:
        ...
        Statement:
          - Sid: AllowOwnerAccess
            Effect: Allow
            Principal:
              AWS: !Sub 'arn:aws:iam::875180007397:user/${TraineeUserName}' #TODO: ???の箇所を正しく穴埋めしてください。
            Action: 's3:*'
            Resource:
...
- レポートを作成し、Sharepointの成果物提出フォルダに提出します。「オプション課題」項目は次章で実施するため、ここでは飛ばしてください。
